...
for Updating and under-control in private permission of cooperation

Additional terms:
Do not use this software without Owner PERMISSION

Parts of the software are provided under separate licenses, as follows:
Laravel PHP Framework is Under the MIT License

 For more information on the license summary topics
Website Seller Software & Manage System - Terms and conditions
...
With Attribution Requirements﻿: for Updating and under-control in private permission of cooperation
