        ...
        <section class="content">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Dealer Users</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-16"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                ...
                <tr role="row" class="odd">
                  ...
                  <a href ="#" class="badge badge-info" onclick= "return alert('Coming Link Soon')">See Dealer</a> 

         
                    <a href = "{{route('acc.demote',$usr->id)}}" class="badge badge-danger"  onclick="return confirm('Are you sure to demote dealer this user? Once you done you cannot undo!')" >Demote</a>
                  </td>
                </tr>
                @endforeach
               </tbody>
