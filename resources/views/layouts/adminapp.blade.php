  ...
  <ul class="nav nav-justified" style="text-align: center;">
   <li> 
    ...
    <img src="{{url('/images/logo.png')}}" style="width: 60%" >
        ...
        <ul class="nav nav-pills flex-column marginbot20">
         ...
         <ul class="nav nav-pills flex-column marginbot20" >
            ...
            <li class ="nav-item">
                   ...
                   <a class="nav-link {{ isActiveRoute('cat.edit') }} blackfont">⚫Users Management</a>
             
                
            </li>

            <li class="nav-item">
              <a class="nav-link {{ isActiveRoute('addcat') }} blackfont" href="{{route('addcat')}}">Add Users</a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ isActiveRoute('addcat') }} blackfont" href="{{route('indexcat')}}">Edit/View Users</a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ isActiveRoute('addcat') }} blackfont" href="{{route('indexcat')}}">Dealers Users</a>
            </li>
        ...
        <main class="col-sm-9 col-md-10  pt-3" style="   "> <!-- py-4 -->
            @yield('content')
        </main>
    </div>
</div>
