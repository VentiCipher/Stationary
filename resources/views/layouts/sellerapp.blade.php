...
<!-- THIS IS DROPDOWNS STOCK-->
                 <li class="nav-item dropdown centerdrop">
                                <a id="navbarDropdown" class="nav-link dropdown" style="margin-bottom: -4%" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <div class="tooltip">
  ...
  <ul class="nav nav-justified" style="text-align: center;">
   <li> 
    ...
    <img src="{{url('/images/logo.png')}}" style="width: 60%" >
        ...
        <div class="container-fluid">
        <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar removepadding border border-primary rounded" style ="background-color:#f3f3f3 ;" >
        
        <ul class="nav nav-pills flex-column marginbot20">
            <li class="nav-item">
              <a class="nav-link {{ isActiveRoute('dashboardindex') }} blackfont" href="{{route('dashboardindex')}}">Dashboard <span class="sr-only">(current)</span></a>
            </li>
         ...
         <ul class="nav nav-pills flex-column marginbot20" >
            ...
            <li class="nav-item">
              <a class="nav-link {{ isActiveRoute('addcat') }} blackfont" href="{{route('addcat')}}">Add Categories</a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ isActiveRoute('indexcat') }} blackfont" href="{{route('indexcat')}}">Edit/View Categories</a>
            </li>
         ...
         <ul class="nav nav-pills flex-column marginbot20" >
            ...
            <li class="nav-item">
              <a class="nav-link {{ isActiveRoute('acc.show.add') }} blackfont" href="{{route('acc.show.add')}}">Add Users</a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ isActiveRoute('acc.index') }} blackfont" href="{{route('acc.index')}}">Edit/View Users</a>
            </li>
             <li class="nav-item">
              <a class="nav-link {{ isActiveRoute('acc.show.manage') }} blackfont" href="{{route('acc.show.manage')}}">Dealers Management</a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ isActiveRoute('acc.show.approve') }} blackfont" href="{{route('acc.show.approve')}}">Pending Dealers Approval</a>
            </li>
