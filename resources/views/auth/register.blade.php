...
@section('content')
    ...
    @endif
    <form id = "formid" class="form-horizontal"  onsubmit="setup()" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <h1>Sign Up</h1>
        <br>
        <fieldset>
        ...
        <fieldset>
            ...
            <legend><span class="number">3</span>Your Contact</legend>
