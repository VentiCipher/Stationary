            ...
            <div class="row">
                <div class="col-md-6 card-body">
                    <form method="POST" action="{{ route('order.show.fetch') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="invoice" required>
                                    <option value="personal" default>Personal</option>
                                    <option value="company">Company LTD, Trading</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="methods" required>
                                    <option value="creditcard" default>Credit Card | Debit Card</option>
                        ...
                        <div class="form-group row">
                            <label for="cards" class="col-md-4 col-form-label text-md-right">Credit | Debit Cards
                                No.</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                    <textarea id="address" name="address" class="form-control"
                                              style="    width: 75%;height: 45%;" required></textarea>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('orderreviewdata.index',$item->id)}}"
                                                   class="label label-primary">Use this Detail</a>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        @else
                            <label for="invoice" class="col-md-12 col-form-label text-md-lefr">No History of
                                Order</label>
                            <br>
                            <label for="invoice" class="col-md-12 col-form-label text-md-lefr">Once you ordered you can
                                choose data from here</label>
                        @endif
                    </div> {{--invoice--}}
